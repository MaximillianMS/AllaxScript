 ...
 */
    ...
    namespace SIMPRA
    {
        ...
        class PriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
            ...
            where TPriority : IComparable<TPriority>
        {
            ...
            //public bool RemoveAllWithValue(TValue value)
            //{
            //    bool result = false;
            //    List<KeyValuePair<TPriority, TValue>> tmp = new List<KeyValuePair<TPriority, TValue>>();
            //    foreach (var iter in _baseHeap)
            //    {
        ...
        class PriorityQueueStable<TPriority, TValue>
            where TPriority : IComparable<TPriority>
            where TValue : IComparable<TValue>
        {
            private SortedDictionary<TPriority, Queue<TValue>> list = new SortedDictionary<TPriority, Queue<TValue>>();
            public void Enqueue(TPriority priority, TValue value)
            {
                Queue<TValue> q;
            ...
            public List<TValue> ToList()
            {
                ...
                List<KeyValuePair<TPriority, Queue<TValue>>> listView = list.ToList();
                foreach (KeyValuePair<TPriority, Queue<TValue>> kvp in listView)
                {
                    results.AddRange(kvp.Value.ToList());
                }
