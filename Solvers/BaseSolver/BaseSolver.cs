    ...
    public class BaseSolver:ISolver
    {
        ...
        protected virtual bool SLayer(SolverParams SolParams)
        {
            ...
            for (; SolParams.BIndex <Blocks.Count; SolParams.BIndex++)
            {
                ...
                var Params = new BlockStateExtrParams(WayBlock.Inputs, SolParams.Engine.GetMultiThreadPrevalence(), SolParams.P, SolParams.Type, /*true/*/SolParams.CheckPrevalence);
        ...
        protected virtual void PLayer(SolverParams SolParams)
        {
            ...
            var Params = new BlockStateExtrParams(Block.Inputs, new Prevalence(), new Prevalence(), SolParams.Type);
        ...
        protected virtual void FinishSolving(SolverParams SolParams)
        {
            ...
            WayConverter.CopyOutToIn(SolParams.Way, SolParams.Way.layers.Count - 3, SolParams.Way.layers.Count - 2);
